...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=haibui.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x22, 0xa4, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79,
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x68, 0x61, 0x69, 0x62, 0x75, 0x69, 0x2e, 0x70, 0x63,
	...
	0x49, 0x54, 0x10, 0x01, 0x12, 0x0c, 0x0a, 0x08, 0x4b, 0x49, 0x4c, 0x4f, 0x42, 0x59, 0x54, 0x45,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: haibui.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: haibui.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: haibui.pcbook.Memory.unit:type_name -> haibui.pcbook.Memory.Unit
