...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=haibui.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x0b, 0x32, 0x20, 0x2e, 0x68, 0x61, 0x69, 0x62, 0x75, 0x69, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f,
	...
	0x2e, 0x68, 0x61, 0x69, 0x62, 0x75, 0x69, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53,
	...
	0x04, 0x4f, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x42, 0x29, 0x0a, 0x1f, 0x63, 0x6f, 0x6d, 0x2e, 0x67,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: haibui.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: haibui.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: haibui.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: haibui.pcbook.Screen.resolution:type_name -> haibui.pcbook.Screen.Resolution
	0, // 1: haibui.pcbook.Screen.panel:type_name -> haibui.pcbook.Screen.Panel
