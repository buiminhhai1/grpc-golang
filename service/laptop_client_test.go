...
import (
	...
	"github.com/buiminhhai/pcbook/sample"
	"github.com/buiminhhai/pcbook/serializer"
	"github.com/buiminhhai/pcbook/service"
...
func TestClientCreateLaptop(t *testing.T) {
	...
	// check that the saved laptop is the same as one we send
