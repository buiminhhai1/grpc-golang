...
// SearchLaptop searches laptop with filter and return stream laptops
...
// UploadImage uploads stream image an return id and info of image
func (server *LaptopServer) UploadImage(stream pb.LaptopService_UploadImageServer) error {
	...
	log.Printf("receive an upload image request for laptop %s with image typ %s", laptopID, imageType)
...
// with a score, and returns a stream of avarage score for each of them
