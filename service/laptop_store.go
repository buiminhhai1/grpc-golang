...
type LaptopStore interface {
	...
	// Search searches laptops with filter, returns one by one via the found function
...
// NewInMemoryLaptopStore returns a new InMemoryLaptopService
